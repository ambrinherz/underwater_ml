...
def train(csv_filename, pred_column, output_prefix):
	...
	save(scalar, '{}-BaggingwithTree-500-{}.scalar'.format(output_prefix, time.time()))
	...
	for algo in algos:
		...
		save(model, '{}-BaggingwithTree-500-{}.model'.format(output_prefix, time.time()))
...
def list_algos():
	...
	return [BaggingRegressor(n_estimators=500)]
